...
describe('classNames', () => {
    ...
    test('Testing a function with additional class and mods', () => {
        ...
        expect(classNames('someClass', { hovered: true, scrollable: true }, ['classAgain1', 'classAgain2'])).toBe(expected);
    });
    ...
    test('Testing a function with additional class and mods, only one mode is false', () => {
        ...
        expect(classNames('someClass', { hovered: true, scrollable: false }, ['classAgain1', 'classAgain2'])).toBe(expected);
    });

    test('Testing a function with additional class and mods, only one mode is undefined', () => {
        const expected = 'someClass classAgain1 classAgain2 hovered';
        expect(classNames('someClass', { hovered: true, scrollable: undefined }, ['classAgain1', 'classAgain2'])).toBe(expected);
    });
});
